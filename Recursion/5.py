...
names = ["Riya", "Christopher", "Aman", "Neha", "Siddharth"]
def longest_name(names):
    return reduce(lambda x, y: x if len(x) > len(y) else y, names)
longest_student = longest_name(names)
print("Student with the longest name:", longest_student)