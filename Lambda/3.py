...
prices=list(map(int,input("Enter the product prices:").split()))
eligible_prices = list(filter(lambda x: x >= 2000, prices))
discounted_prices = list(map(lambda x: x * 0.8, eligible_prices))
